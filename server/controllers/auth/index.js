...
const signUp = (req, res) => {
    ...
    (0, express_validator_1.check)('password', 'Password must be at least 8 characters long').isLength({ min: 8 });
...
exports.default = { signUp, login, testAuth, forgotPas };
