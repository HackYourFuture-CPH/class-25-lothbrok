...
const firebaseConfig = {
  apiKey:"AIzaSyBVggofWM5oDyECNAGALX3s8bY0MLcFFF0", //process.env.REACT_APP_API_KEY,
  authDomain: "project-management-c03e4.firebaseapp.com",//process.env.REACT_APP_DOMAIN,
